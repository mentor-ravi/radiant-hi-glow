    ...
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        ...
        <BrowserRouter>
          ...
          <Route path="/dashboard/admin-old" element={<ProtectedRoute><AdminDashboard /></ProtectedRoute>} />
          <Route path="/dashboard/admin" element={<ProtectedRoute><AdminLayout><AdminOverview /></AdminLayout></ProtectedRoute>} />
          <Route path="/dashboard/admin/events" element={<ProtectedRoute><AdminLayout><AdminEvents /></AdminLayout></ProtectedRoute>} />
          <Route path="/dashboard/admin/courses" element={<ProtectedRoute><AdminLayout><AdminCourses /></AdminLayout></ProtectedRoute>} />
          <Route path="/dashboard/admin/tasks" element={<ProtectedRoute><AdminLayout><AdminTasks /></AdminLayout></ProtectedRoute>} />
          <Route path="/dashboard/admin/users" element={<ProtectedRoute><AdminLayout><AdminUsers /></AdminLayout></ProtectedRoute>} />
          <Route path="/dashboard/admin/chat" element={<ProtectedRoute><AdminLayout><AdminChat /></AdminLayout></ProtectedRoute>} />
          <Route path="/dashboard/admin/mentorship" element={<ProtectedRoute><AdminLayout><AdminMentorship /></AdminLayout></ProtectedRoute>} />
          <Route path="/dashboard/admin/leaderboard" element={<ProtectedRoute><AdminLayout><AdminLeaderboard /></AdminLayout></ProtectedRoute>} />
          <Route path="/dashboard/admin/certificates" element={<ProtectedRoute><AdminLayout><AdminCertificates /></AdminLayout></ProtectedRoute>} />
          <Route path="/dashboard/admin/media" element={<ProtectedRoute><AdminLayout><AdminMedia /></AdminLayout></ProtectedRoute>} />
          <Route path="/dashboard/admin/analytics" element={<ProtectedRoute><AdminLayout><AdminAnalytics /></AdminLayout></ProtectedRoute>} />
          <Route path="/dashboard/admin/notifications" element={<ProtectedRoute><AdminLayout><AdminNotifications /></AdminLayout></ProtectedRoute>} />
          <Route path="/dashboard/admin/settings" element={<ProtectedRoute><AdminLayout><AdminSettings /></AdminLayout></ProtectedRoute>} />
