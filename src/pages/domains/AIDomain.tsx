...
import { ExplorationBranchCards } from "@/components/learning-tree/ExplorationBranchCards";
...
const AIDomain = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      {/* Exploration Branch Cards */}
      <ExplorationBranchCards domainId={domain.id} domainName={domain.name} />
    </div>
  );
};
